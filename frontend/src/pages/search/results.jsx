  ...
  return !searching ? (
    <>
      ...
      {totalProducts > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-[50vh] gap-6 p-4 md:p-6">
          <div className="text-center space-y-2">
            <h2 className="text-2xl font-bold">No Results Found</h2>
            <p className="text-muted-foreground">
              It seems we don't have any products matching your search. Please
              try a different keyword.
            </p>
          </div>
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-black text-white px-4 py-2 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2"
          >
            Back to Shop
          </Link>
        </div>
